        ...
        <section className="workspace-hero">
          <div className="workspace-hero__copy">
            ...
            <p className="workspace-hero__description">
              Add the identity and regional details needed for account eligibility. No trading experience is required — iRexPro is designed to run the trading workflow for you.
            </p>
          </div>
